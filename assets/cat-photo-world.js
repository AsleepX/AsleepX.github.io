...
export const photoScenes = {
  ...
  'passing-cat': [
    // Left arc sampled from the green tube in the 2200 × 1650 photo.
    // Its outer edge begins at x=.160; the area to its left is empty background.
    ['chair-back', [[.160,.4079],[.161,.397],[.163,.3824],[.168,.3648],[.174,.3491],[.182,.3333],[.195,.3121],[.205,.2988],[.22,.283],[.232,.2727],[.243,.2642],[.253,.26],[.263,.2552],[.282,.2503],[.30,.257],[.338,.283],[.367,.326],[.382,.366]]],
